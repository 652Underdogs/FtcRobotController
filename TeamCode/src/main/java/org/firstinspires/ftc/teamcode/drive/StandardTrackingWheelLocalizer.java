...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double FORWARD_OFFSET = 7.125; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 0.28; //Multiplier in the X direction.
    public static double Y_MULTIPLIER = 0.28; //Multiplier in the Y direction.
